...
class Outro2 extends Phaser.Scene {
  ...
  preload ()
  {
    ...
    this.load.image("picture1", introAssets.picture1o2Img);
    this.load.image("picture2", introAssets.picture2o2Img);
    this.load.image("picture3", introAssets.picture3o2Img);
    this.load.image("picture4", introAssets.picture4o2Img);
    this.load.image("picture5", introAssets.picture5o2Img);
